/* ============================================================
   shared/sem2-rail.js — LIU33008 Semantics II
   Fills the deck chrome at runtime. Sister to deck-rail.js
   (Semantics I): reads <body data-week="N">, looks the week up
   in window.WEEKS (sem2-meta.js, loaded first), and populates:
     · every .b-rail                 (left progress rail)
     · every .lxd2-foot[data-lens]   (divider bottom stepper)
     · every .lens-progress[data-lens] (content-slide stepper)
   No week-switching: each deck file is a single week.
   ============================================================ */
(function () {
  var CREST = "../../shared/tcd-crest.webp";
  var LENS_ORDER = ["empirical", "historical", "formal", "typological"];
  var LENS_LABELS = { empirical: "Empirical", historical: "Historical", formal: "Formal", typological: "Typological" };
  ...
  function railHTML(wk) {
    ...
    return '' +
      ...
      '  <div class="b-mark-txt"><div class="t">Semantics<br>II</div><div class="c">LIU33008</div></div>' +
      '</div>' +
  ...
  function init() {
    ...
    if (!wk) { console.warn("sem2-rail: no week meta for data-week=" + no); return; }
