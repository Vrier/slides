/* ============================================================
   shared/prag2-rail.js — fills the deck chrome for LIU44008.
   Same job as prag-rail.js, branded "Pragmatics II / LIU44008".
   Reads <body data-week="N"> → window.WEEKS (prag2-meta.js first).
   Pragmatics II is organised by THREE APPROACHES, not the four
   lenses — so the divider/lens steppers are usually absent; the
   stepper helpers below simply no-op when their elements aren't
   present, and the left progress rail tracks MODULE_SECTIONS.
   ============================================================ */
(function () {
  ...
  function railHTML(wk) {
    ...
    return '' +
      ...
      '  <div class="b-mark-txt"><div class="t">Pragmatics<br>II</div><div class="c">LIU44008</div></div>' +
      '</div>' +
  ...
  function init() {
    ...
    if (!wk) { console.warn("prag2-rail: no week meta for data-week=" + no); return; }
