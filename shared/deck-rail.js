/* ============================================================
   shared/deck-rail.js — fills the deck chrome at runtime.
   Reads <body data-week="N">, looks the week up in window.WEEKS
   (week-meta.js, loaded first), and populates:
...
(function () {
  ...
  function railHTML(wk) {
    ...
    return '' +
      ...
      '  <div class="b-mark-txt"><div class="t">Describing<br>Meaning</div><div class="c">LI7869</div></div>' +
      '</div>' +
  ...
  function init() {
    ...
    if (!wk) { console.warn("deck-rail: no week meta for data-week=" + no); return; }
